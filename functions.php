<?php
    ...
    add_image_size( 'slider-fullwidth', 2880, 9999, array( 'center', 'center' ) ); // 300 pixels wide (and unlimited height)
    ...
    add_image_size( 'large-image', 579, 413 ); // For oages what we do and materials
